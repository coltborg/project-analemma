---
categories: ['CSS', 'React', 'Accessibility']
date: '2019-06-03'
description: 'How to use Tailwind CSS to style a semantic, reusable blockquote that looks great.'
emoji: '💅'
keywords: ['tailwindcss', 'blockquote', 'css', 'react']
slug: '/style-a-blockquote-using-tailwindcss'
...
![Redesign `blockquote` to add an avatar for more personality, increased font size and italtics, plus a stylized quote mark in the background.](../images/quote-redesign.png)
...
```git
+ <blockquote className="p-4 bg-neutral-100 text-neutral-600 border-l-4 border-neutral-500 italic quote relative text-xl">
- <blockquote className="p-4 bg-neutral-100 text-neutral-600 border-l-4 border-neutral-500 italic quote">
...
- <cite>
-   -
+ <img alt="Avatar of nickd" className="mr-4 w-12 bg-neutral-500 rounded-full" src="..." />
+ <div className="flex flex-col items-start">
+   <span className="mb-1 text-sm font-bold italic">
+     nickd
+   </span>
    <a className="text-sm" href="..." target="_blank" rel="noopener noreferrer">
+     Draft
...
const Quote = () => (
  <blockquote className="p-4 bg-neutral-100 text-neutral-600 text-xl border-l-4 border-neutral-500 italic relative quote">
    ...
    <cite className="flex items-center">
      ...
      />
      <div className="flex flex-col items-start">
        <span className="mb-1 text-sm font-bold italic">nickd</span>
        <a
          href="..."
          target="_blank"
...
You can see the quote upgrades I made for this site over on [github](https://github.com/coltborg/project-analemma/blob/master/src/components/quote.js).